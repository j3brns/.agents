...
- `docs/SPEC.md` — normative spec (current: v0.10). §0 decision log D1–D31 is load-bearing.
- `docs/adr/` — 26 immutable ADRs. **Never edit an accepted ADR**; supersede with a new one.
