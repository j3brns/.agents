...
- `docs/SPEC.md` — normative spec (current: v0.7). §0 decision log D1–D22 is load-bearing.
- `docs/adr/` — 17 immutable ADRs. **Never edit an accepted ADR**; supersede with a new one.
