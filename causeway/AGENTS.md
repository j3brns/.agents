...
- `docs/SPEC.md` — normative spec (current: v0.4). §0 decision log D1–D18 is load-bearing.
- `docs/adr/` — 14 immutable ADRs. **Never edit an accepted ADR**; supersede with a new one.
